...
export const metadata: Metadata = {
  title: "Tarife și Prețuri | Clinica Doctor Curt",
  description: "Lista completă de tarife pentru serviciile stomatologice oferite de Clinica Doctor Curt: implanturi dentare, fațete, albire profesională, aparate dentare și altele.",
};
