        ...
        >
          <div className="bg-white/90 backdrop-blur-xl border-t border-neutral-200 px-5 py-3 shadow-elevated">
            <div className="flex items-center justify-between gap-3 max-w-7xl mx-auto">
              ...
              <a
                href="/programare"
                className="flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-gradient-to-r from-accent-400 to-accent-500 text-primary-950 font-bold text-sm hover:shadow-lg transition-all flex-1"
              >
