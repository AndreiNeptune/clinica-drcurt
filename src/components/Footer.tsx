        ...
        <div className={cn(
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-neutral-400 text-sm leading-relaxed mt-5 mb-6">
              Proceduri sigure, complet fără durere, cu rezultate vizibile
              încă de la prima ședință. Zâmbetul tău, misiunea noastră.
            </p>
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-10 h-10 rounded-xl bg-neutral-800 text-neutral-400 flex items-center justify-center hover:bg-gradient-to-br hover:from-pink-500 hover:to-purple-600 hover:text-white transition-all duration-300"
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-4 mb-8">
              <li>
                ...
                >
                  ...
                  <span className="text-sm text-neutral-400 group-hover:text-primary-400 transition-colors">
                    Str. Vulturilor nr. 93 A,
                    <br />Sector 3, București
                  </span>
                </a>
              </li>
              <li>
                <a href="tel:0724542600" className="flex items-center gap-3 group">
              ...
              <li>
                <a href="mailto:doctor.curt.nicu@gmail.com" className="flex items-center gap-3 group">
            ...
            <div className="mt-auto rounded-xl overflow-hidden h-[150px] border border-neutral-800 relative group">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d5698.517138806031!2d26.122606!3d44.427858!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40b1f9aa4c42837f%3A0xcd820522e5819cf!2sClinica%20Doctor%20Curt!5e0!3m2!1sen!2sus!4v1775421957553!5m2!1sen!2sus" 
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
          ...
          {!isAppointmentPage && (
            <div>
              ...
              {submitted ? (
                <div className="bg-primary-900/30 border border-primary-700/30 rounded-2xl p-6 text-center">
                  <div className="w-12 h-12 mx-auto rounded-full bg-primary-500/20 flex items-center justify-center mb-3">
                    <Send className="w-5 h-5 text-primary-400" />
                  </div>
                  <p className="text-primary-300 font-semibold mb-1">Mesaj trimis!</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-neutral-500 text-xs">
              © {new Date().getFullYear()} Clinica Doctor Curt. Toate drepturile rezervate.
            </p>
